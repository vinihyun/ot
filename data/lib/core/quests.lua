		...
		[24] = {
			...
			missions = {
				[1] = {
					...
					endValue = 7,
					states = {
						[1] = "Your mission is to investigate the 5 guards in Hammerfell regarding the Heretic behavior. \z
						Tim, Kulag, Grof, Miles and Walter are their names. If you do well you see a holy sprite on you.",
						[2] = "You investigated 1 of 5 guards in Hammerfell",
						[3] = "You investigated 2 of 5 guards in Hammerfell.",
						[4] = "You investigated 3 of 5 guards in Hammerfell.",
						[5] = "You investigated 4 of 5 guards in Hammerfell.",
						[6] = "You investigated 5 of 5 guards in Hammerfell. Get back to Hammerfell and report your mission to Henricus.",
						[7] = "You investigated all guards in Hammerfell."
					}
				},
				[2] = {
				...
				[4] = {
					...
					endValue = 3,
					states = {
						[1] = "Henricus will gave you a Special Flask (vial of holy water). Go to Hammerfell \z
						and use the vial on an old house. Use this vial of holy water on that spot to drive out the evil being.",
						[2] = "Kill the Pirate Ghost and get back to report your mission to Henricus.",
						[3] = "You already cleaned the abandoned and haunted house in Hammer, ask Henricus for mission."
					}
				},
				[5] = {
